...
void main() {
  group('Steganograph', () {
    ...
    test('embedText and extractText', () {
      ...
      final extractedText =
          steganograph.extractText(image: imageWithText, length: text.length);
    ...
    test('embed and extract image', () {
      ...
      Image embeddedImage = steganograph.embedImage(
        coverImage: coverImage,
        secretImage: secretImage,
      );
      Image extractedImage = steganograph.extractImage(
